...
export function PlusCircleIcon({ className, filled }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill={filled ? "currentColor" : "none"}
    ...
    >
      ...
      <path d="M12 8v8M8 12h8" stroke={filled ? "var(--background)" : "currentColor"} />
    </svg>
  );
}

export function SlidersIcon({ className, filled }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill={filled ? "currentColor" : "none"}
...
export function QueueIcon({ className, filled }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill={filled ? "currentColor" : "none"}
